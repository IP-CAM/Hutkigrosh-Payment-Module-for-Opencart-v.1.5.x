            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    <tr>
                        ...
                        <td><input type="text" name="hutkigrosh_storeid" value="<?php echo $hutkigrosh_storeid; ?>"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="hutkigrosh_erip_tree_path"
                                   value="<?php echo $hutkigrosh_erip_tree_path; ?>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="hutkigrosh_sort_order"
                                   value="<?php echo $hutkigrosh_sort_order; ?>"/></td>
                    </tr>
                    <tr>
